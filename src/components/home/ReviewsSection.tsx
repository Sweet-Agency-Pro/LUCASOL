      ...
      <Container>
        ...
        <div className="relative">
                ...
                >
                  <Card className="h-full" hover={false}>
                    ...
                    <div className="mt-4 pt-4 border-t border-gray-100">
                      <p className="font-semibold text-neutral-dark text-sm">{review.client}</p>
          ...
          <button
            onClick={prev}
            disabled={current === 0}
            className="absolute -left-4 top-1/2 -translate-y-1/2 w-10 h-10 rounded-full bg-white shadow-md flex items-center justify-center hover:bg-gray-50 disabled:opacity-30 disabled:cursor-not-allowed transition-opacity"
          ...
          <button
            ...
            className="absolute -right-4 top-1/2 -translate-y-1/2 w-10 h-10 rounded-full bg-white shadow-md flex items-center justify-center hover:bg-gray-50 disabled:opacity-30 disabled:cursor-not-allowed transition-opacity"
